...
/***/ function(module, exports, __webpack_require__) {
	...
	var express = __webpack_require__(3),
	    ...
	    wordSearch = __webpack_require__(8);
	
	var words = JSON.parse(__webpack_require__(11).readFileSync('./data/treeWords.json'));
	var wordList = { "list": words, "length": words.length };
	var tree = JSON.parse(__webpack_require__(11).readFileSync('./data/pruned_tree.json'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(1);
	var pt = __webpack_require__(9);
	var _exports = module.exports = {};
	
	_exports.rand = function (wordList) {
		...
		try {
			for (var _iterator = word[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
				...
				var symbolString = symbol[0].toUpperCase() + symbol.slice(1);
				var element = pt.symbols[symbolString];
